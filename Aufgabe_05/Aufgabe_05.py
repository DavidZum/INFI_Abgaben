...
model.save('Aufgabe_05/model.h5')
model.save_weights("Aufgabe_05/model.weights.h5")

weights = model.get_weights()
j =json.dumps(pd.Series(weights).to_json(orient='values'), indent=3)
print(j)

model = keras.models.load_model('Aufgabe_05/model.h5')
model.load_weights("Aufgabe_05/model.weights.h5")
